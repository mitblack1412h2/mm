                    ...
                    <tbody>
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                        ...
                        <tr>
                            ...
                            <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'><font color="red">Remove</font></a></th>
                        </tr>
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>$ <?php echo $sum;?></th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-success">Confirm</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
